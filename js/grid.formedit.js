	...
	editGridRow : function(rowid, p){
		...
		return this.each(function(){
			...
			function getFormData(){
				...
				var exclude = $("div.ui-jqgrid[id^='gbox_'] form.FormGrid .FormElement, .ui-search-input input, .ui-search-input select", $(frmtb).closest('form'));
					...
					$(cm).each(function(){
						...
						if(fld && fld.length && fld[0] !== null) {
							...
							if(this.edittype === 'custom' && $.isFunction(opt.custom_value)) {
								...
								var exclude = $("div.ui-jqgrid[id^='gbox_'] form.FormGrid .FormElement, .ui-search-input input, .ui-search-input select", $("#"+fmid).closest('form'));
			...
			function getCurrPos() {
				...
				exclude = $("div.ui-jqgrid[id^='gbox_'] form.FormGrid .FormElement, .ui-search-input input, .ui-search-input select", $(frmtb).closest('form')),
