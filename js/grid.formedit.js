		...
		return this.each(function() {
			...
			function showFilter(_filter) {
				...
				if(showFrm) {
					...
					$.jgrid.viewModal("#"+$.jgrid.jqID(IDs.themodal),{gbox:"#gbox_"+$.jgrid.jqID(fid),jqm:p.jqModal, modal:p.modal, overlay: p.overlay, focusSelector:rp_ge.focusSelector, toTop: p.toTop});
					//shuki end
	...
	editGridRow : function(rowid, p){
		...
		return this.each(function(){
			...
			$.jgrid.viewModal("#"+$.jgrid.jqID(IDs.themodal),{
				...
				//shuki pass the focusSelector to viewModal to enable not setting the focus 2012-12-11
				focusSelector:rp_ge.focusSelector,
				//shuki end
				onHide :  function(h) {
					$($t).data("formProp", {
	...
	delGridRow : function(rowids,p) {
		...
		return this.each(function(){
			...
			if ( $("#"+$.jgrid.jqID(IDs.themodal))[0] !== undefined ) {
				...
				$.jgrid.viewModal("#"+$.jgrid.jqID(IDs.themodal),{gbox:"#gbox_"+$.jgrid.jqID(gID),jqm:rp_ge[$t.p.id].jqModal,jqM: false, overlay: rp_ge[$t.p.id].overlay, focusSelector:rp_ge.focusSelector, modal:rp_ge[$t.p.id].modal});
				//shuki end
				...
				$.jgrid.viewModal("#"+$.jgrid.jqID(IDs.themodal),{gbox:"#gbox_"+$.jgrid.jqID(gID),jqm:rp_ge[$t.p.id].jqModal, overlay: rp_ge[$t.p.id].overlay, focusSelector:rp_ge.focusSelector, modal:rp_ge[$t.p.id].modal});
				//shuki end
				if(onAfterShow) {rp_ge[$t.p.id].afterShowForm.call($t,$("#"+dtbl));}
			}
